...
struct RepetitiveDiveView: View {
    ...
    var body: some View {
        Group {
            ...
            // Dive 2 levels
            Text("Dive 2 Profile (\(vm.unitSystem.depthUnit) / min)").font(.subheadline).foregroundStyle(OVMTheme.textSecondary)
            ...
            GasPickerRow(gas: $vm.bottomGas2, showSwitch: false, unitSystem: vm.unitSystem)
